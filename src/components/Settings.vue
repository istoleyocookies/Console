    ...
    <div class="container">
      <div class="content content-container">
        ...
        <div class="settings-item">
          ...
          <p>
            Your API keys are below. Revoking a key will invalidate it. Note that your <strong>SessionToken</strong>
      ...
      <div>
          <p>
            <b-table
              ...
              <template slot-scope="props">
                ...
                <b-table-column field="LastUsed" label="Last Used">
                  {{ props.row.Created }}
                </b-table-column>
          ...
          <div class="content content-container settings-item">
            ...
            <b-modal :active.sync="isNewApiKeyModalActive" scroll="keep" @close="clearNewApiKeyValues" :width="960" >
...
Secret: {{ this.newApiKeySecret }}
        ...
        <div class="content" v-if="userRole === 'admin'">
          <div class="settings-item content-container">
            ...
            <p>
              Define the users for faction here.
            </p>
            <ul>
            ...
            <p>
              <b-table
                ...
                <template slot-scope="props">
                  ...
                  <b-table-column field="LastLogin" label="Last Login">
                    {{ props.row.LastLogin }}
                  </b-table-column>
